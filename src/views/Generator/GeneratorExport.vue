            ...
            <div class="columns">
                ...
                <div class="column">
                    <button
                        ...
                        @click="download('settings.json', theme)">Export
                    </button>
                </div>
            </div>
            <div class="columns">
                ...
                <div class="column">
                    <button
                        ...
                        @click="download('custom.scss',  process())">Download
                    </button>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        process() {
            const out = JSON.stringify(this.$store.state.themeGenerator);

            return generate(JSON.parse(out))
        }
    },
}
</script>
